                         ...
                         Row(
                           children: [
                             MaterialButton(
                              ...
                              onPressed: (){},child: Text("طلبات  قيد الانتظار ",style: TextStyle(fontSize: 15,color: Colors.white,fontWeight: FontWeight.bold),),
                              ),
                           ],
                         ),
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: List.generate(
                          ordersController.listordersNow.length,
                          (i) => Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text("${ordersController.listordersNow[i].createDate}",style: TextStyle( color: Color.fromARGB(255, 175, 169, 169),fontSize: 22, fontWeight: FontWeight.bold,),
                                                  ),
                                                ),
                                              ],
                                            ),
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text( "${ordersController.listordersNow[i].orderId}", style: TextStyle(color: Color.fromARGB(255, 187, 185, 185),fontSize: 24, fontWeight: FontWeight.bold,)
                                                  ),
                                                ),
                                              ],
                                            ),
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                   ...
                                                   Text(
                                                          "${ordersController.listordersNow[i].totalPrice}",
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                MaterialButton(
                                                  ...
                                                  onPressed: (){
                                                    Get.to(()=>Datalsmyiorder(),arguments: {"orderId":ordersController.listordersNow[i].orderId,"totalPrice":ordersController.listordersNow[i].totalPrice});
