...
class ComplaintsPages extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 246, 245, 245),
      appBar: AppBar(title: Text("تواصل معنا ",style: TextStyle(fontSize: 25,color: Colors.white),
              ...
              child: SingleChildScrollView(
               ...
               Row(
                ...
                children: [
                   ...
                   Icon(Icons.phone,size: 25,color: ColorName.colorblue,),


                Padding(
                  padding: const EdgeInsets.only(right:10),
                  child: Text("735567645",style: TextStyle(fontSize: 25,color: ColorName.colorblue),),
                )
               ],
               )
                ],
