...
class MyOrderCancelled extends StatelessWidget {
        ...
        body:GetBuilder<OrdersController>(builder: (controller) {
         if(ordersController.statusRequest==StatusRequest.lodaing){
          return Center(child: Card(
            ...
            child: CircularProgressIndicator(),color: ColorName.colorblue,));
         }else{
          return SafeArea(
          child: Stack(
            children: [
                  ...
                  Padding(
                    ...
                    child:  Row(
                        ...
                        children: [
                           ...
                           children: [
                            ...
                            Row(
                              children: [
                                MaterialButton(
                         shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)),
                          onPressed: (){},child: Text("طلبات  مكتملة  ",style: TextStyle(fontSize: 15,color: Colors.black,fontWeight: FontWeight.bold),),
                          ),
                              ],
                            ),
                                                        Row(
                         ...
                         shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)),
                          onPressed: (){},child: Text("طلبات  تم الغاءها ",style: TextStyle(fontSize: 15,color: Colors.white,fontWeight: FontWeight.bold),),
                          ),
                              ],
                            ),
                        ],
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: List.generate(
                          ordersController.listordersCancels.length,
                          (i) => Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text("${ordersController.listordersCancels[i].createDate}",style: TextStyle( color: Color.fromARGB(255, 175, 169, 169),fontSize: 22, fontWeight: FontWeight.bold,),
                                                  ),
                                                ),
                                              ],
                                            ),
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text( "${ordersController.listordersCancels[i].orderId}", style: TextStyle(color: Color.fromARGB(255, 187, 185, 185),fontSize: 24, fontWeight: FontWeight.bold,)
                                                  ),
                                                ),
                                              ],
                                            ),
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                   ...
                                                   Text(
                                                          "${ordersController.listordersCancels[i].totalPrice}",
                                                 ...
                                                 Row(
                                                  ...
                                                  children: [
                                                   ...
                                                   Text(
                                                          "${ordersController.listordersCancels[i].typeService=="0"?"حجز":"توصيل"}",
                                                          style: TextStyle( color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20,
                                                          ),
                                                        ),
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                MaterialButton(
                                                  ...
                                                  onPressed: (){
                                                    Get.to(()=>Datalsmyiorder(),arguments: {"orderId":ordersController.listordersNow[i].orderId,"totalPrice":ordersController.listordersCancels[i].totalPrice});
